...
| 类别 | 检查项 | 典型 AI 痕迹 | ✅ 改写后 |
|---|---|---|---|
| 词汇 | 过度使用的 AI 词汇 | 此外、至关重要、深入探讨、强调、持久的、格局、关键性的、展示、宝贵的、充满活力的 | 直接删掉或用更具体的词替换 |
| 词汇 | 填充短语 | 值得注意的是、不可否认的是、众所周知 | 直接删掉 |
| 句式 | 否定式排比 | 这不仅是一篇文档，更是…… | 只说它是什么 |
| 句式 | 三段式法则 | "无缝、直观、强大的体验" | 只说一个具体点 |
| 句式 | 破折号过度使用 | 每段结尾都用 "——" | 用句号结束 |
| 内容 | 宣传和广告式语言 | "提供卓越体验""显著提升效率" | 说具体做了什么 |
| 内容 | 通用积极结论 | "总之，该软件强大的功能……" | 直接结束，不加总结 |
| 风格 | 模糊归因 | "行业专家认为""用户普遍反映" | 有就具名，没有就不写 |
| 风格 | 空洞的范围 | "该软件涵盖了各种……" | 列出具体模块名 |

完整 24 种模式参考 [humanizer-zh](https://github.com/op7418/humanizer-zh)。
